...
from bascenev1 import get_chat_messages as GCM
...
class Singl_buyer(babase.Plugin):
    ...
    def setup_ui(s):
        ...
        def new_init(self, *args, **kwargs):
            ...
            button = bw(
                ...
                size=(40, 40),
                color=button_color,
                on_activate_call=ba.Call(s.show_main_panel)
            )
            s.ui_button = button
            return result
    ...
    def create_window(s, width=480, height=380, is_main=False):
        ...
        if is_main:
            cw(w, on_outside_click_call=ba.Call(s.close_window, w))
        else:
            cw(w, on_outside_click_call=ba.Call(s.close_and_return_to_main, w))
    ...
    def show_main_panel(s):
        ...
        s.status_button = bw(
            ...
            color=status_color,
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.toggle_plugin_from_panel, w)
        )
        ...
        s.anti_recoil_button = bw(
            ...
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.toggle_anti_recoil_from_panel, w)
        )
        ...
        s.normal_button = bw(
            ...
            color=normal_color,
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.set_normal_mode_from_panel, w)
        )
        ...
        s.performance_button = bw(
            ...
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.set_best_performance_from_panel, w)
        )
        buttons = [
            ('Item Settings', ba.Call(s.show_item_settings, w), (165, 250)), 
            ('Backup & Restore', ba.Call(s.show_backup_restore, w), (165, 150)),
            ('Support', ba.Call(s.open_support), (320, 90)),
            ('Channel', ba.Call(s.open_channel), (30, 90)),
        ]
    ...
    def show_performance_confirmation(s, current_window):
        ...
        bw(
            ...
            color=(0.2, 0.8, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.set_best_performance, w)
        )
        ...
        bw(
            ...
            color=(0.8, 0.2, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.close_window, w)
        )
    ...
    def show_item_settings(s, current_window=None):
        ...
        s.item_status_button = bw(
            ...
            color=status_color,
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.toggle_plugin_from_settings, w)
        )
        ...
        s.item_anti_recoil_button = bw(
            ...
            color=anti_recoil_color,
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.toggle_anti_recoil_from_settings, w)
        )
        ...
        s.item_max_total_price_button = bw(
            ...
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.show_max_total_price_dialog, w)
        )
        ...
        if not s.max_prices:
            ...
            for item, max_price in s.max_prices.items():
                ...
                bw(
                    ...
                    textcolor=(1, 1, 1),
                    scale=0.6,
                    on_activate_call=ba.Call(s.delete_item, item, w)
                )
        ...
        bw(
            ...
            color=(0.2, 0.7, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.show_add_item_dialog, w)
        )
    ...
    def show_max_total_price_dialog(s, current_window=None):
        ...
        bw(
            ...
            color=(0.2, 0.7, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.save_max_total_price, price_text, w)
        )
        ...
        bw(
            ...
            color=(0.7, 0.2, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.clear_max_total_price, w)
        )
    ...
    def show_add_item_dialog(s, parent_window=None):
        ...
        bw(
            ...
            color=(0.2, 0.7, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.save_item, item_text, price_text, w, parent_window)
        )
    ...
    def show_backup_restore(s, current_window=None):
        ...
        bw(
            ...
            color=(0.2, 0.5, 0.8),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.create_backup)
        )
        ...
        bw(
            ...
            color=(0.8, 0.5, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.show_restore_list)
        )
        ...
        bw(
            ...
            color=(0.8, 0.2, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.show_reset_confirmation)
        )
        ...
        if not backup_files:
            ...
            for backup_file in backup_files:
                ...
                bw(
                    ...
                    textcolor=(1, 1, 1),
                    scale=0.6,
                    on_activate_call=ba.Call(s.restore_backup, backup_file)
                )
    ...
    def show_reset_confirmation(s):
        ...
        bw(
            ...
            color=(0.8, 0.2, 0.2),
            textcolor=(1, 1, 1),
            on_activate_call=ba.Call(s.reset_settings, w)
        )
